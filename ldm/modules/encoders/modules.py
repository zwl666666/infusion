...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="/home/zwl/codes/custom-diffusion-main/stabilityai/stable-diffusion-xl-base-1.0/openaiclip_vit_large_patch14", device="cuda", max_length=77):
        super().__init__()
